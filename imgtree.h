...
class ImgTree {
    private:
         ...
         *  A collection of these will be used during tree construction to determine the best place to split.
         */
    ...
    private:
        ...
        /*
        count the height of the tree and returns an integer value
        */
       // Declaration of the clearTree function
